...
class VectorKey(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def iterator(self):
        return _repo.VectorKey_iterator(self)
    def __iter__(self):
        return self.iterator()

    def __nonzero__(self):
        return _repo.VectorKey___nonzero__(self)

    def __bool__(self):
        return _repo.VectorKey___bool__(self)

    def __len__(self):
        return _repo.VectorKey___len__(self)

    def __getslice__(self, i, j):
        return _repo.VectorKey___getslice__(self, i, j)

    def __setslice__(self, *args):
        return _repo.VectorKey___setslice__(self, *args)

    def __delslice__(self, i, j):
        return _repo.VectorKey___delslice__(self, i, j)

    def __delitem__(self, *args):
        return _repo.VectorKey___delitem__(self, *args)

    def __getitem__(self, *args):
        return _repo.VectorKey___getitem__(self, *args)

    def __setitem__(self, *args):
        return _repo.VectorKey___setitem__(self, *args)

    def pop(self):
        return _repo.VectorKey_pop(self)

    def append(self, x):
        return _repo.VectorKey_append(self, x)

    def empty(self):
        return _repo.VectorKey_empty(self)

    def size(self):
        return _repo.VectorKey_size(self)

    def swap(self, v):
        return _repo.VectorKey_swap(self, v)

    def begin(self):
        return _repo.VectorKey_begin(self)

    def end(self):
        return _repo.VectorKey_end(self)

    def rbegin(self):
        return _repo.VectorKey_rbegin(self)

    def rend(self):
        return _repo.VectorKey_rend(self)

    def clear(self):
        return _repo.VectorKey_clear(self)

    def get_allocator(self):
        return _repo.VectorKey_get_allocator(self)

    def pop_back(self):
        return _repo.VectorKey_pop_back(self)

    def erase(self, *args):
        return _repo.VectorKey_erase(self, *args)

    def __init__(self, *args):
        _repo.VectorKey_swiginit(self, _repo.new_VectorKey(*args))

    def push_back(self, x):
        return _repo.VectorKey_push_back(self, x)

    def front(self):
        return _repo.VectorKey_front(self)

    def back(self):
        return _repo.VectorKey_back(self)

    def assign(self, n, x):
        return _repo.VectorKey_assign(self, n, x)

    def insert(self, *args):
        return _repo.VectorKey_insert(self, *args)

    def reserve(self, n):
        return _repo.VectorKey_reserve(self, n)

    def capacity(self):
        return _repo.VectorKey_capacity(self)
    __swig_destroy__ = _repo.delete_VectorKey

# Register VectorKey in _repo:
_repo.VectorKey_swigregister(VectorKey)
class Key(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    ...
    @staticmethod
    def keysFromFd(fileDescriptor):
        return _repo.Key_keysFromFd(fileDescriptor)

    def getId(self):
        return _repo.Key_getId(self)

    def getUserId(self):
        return _repo.Key_getUserId(self)

    def getFingerprint(self):
        return _repo.Key_getFingerprint(self)

    def getTimestamp(self):
        return _repo.Key_getTimestamp(self)

    def getAsciiArmoredKey(self):
        return _repo.Key_getAsciiArmoredKey(self)

    def getUrl(self):
        return _repo.Key_getUrl(self)

    def setUrl(self, url):
        return _repo.Key_setUrl(self, url)
    __swig_destroy__ = _repo.delete_Key

# Register Key in _repo:
_repo.Key_swigregister(Key)

def importKeyToPubring(asciiArmoredKey, pubringDir):
    return _repo.importKeyToPubring(asciiArmoredKey, pubringDir)

def keyidsFromPubring(pubringDir):
    return _repo.keyidsFromPubring(pubringDir)
